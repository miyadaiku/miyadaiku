...
""",
    ...
    link = proxy2.link(fragment="h_doc2_html_header1")
    soup = BeautifulSoup(link, "html.parser")
    assert soup.a["href"] == "doc2.html#h_doc2_html_header1"
    assert soup.a.text == "header1"

    link = proxy2.link(fragment="h_doc2_html_header1", text="text")
    soup = BeautifulSoup(link, "html.parser")
    assert soup.a.text == "text"
    ...
    link = proxy2.link(fragment="h_doc2_html_header2")
    soup = BeautifulSoup(link, "html.parser")
