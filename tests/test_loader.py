...
""")
    ...
    assert files._contentfiles[((), "package3_root.rst")].get_body().strip() == b"<p>package3/contents/package3_root.rst</p>"
    assert files._contentfiles[((), "package_root.rst")].get_body().strip() == b"<p>package3/contents/package_root.rst</p>"
    assert files._contentfiles[((), "package3_files_1.rst")].get_body().strip() == b"package3/files/package3_file_1.rst"
    
    assert files._contentfiles[((), "package4_root.rst")].get_body().strip() == b"<p>package4/contents/package4_root.rst</p>"
...
"""
    ...
    assert set(f.src.contentpath for f in found) == set([((), 'a.rst'), ((), 'b.rst'), (('sub1',), 'c.rst')])
    ...
    d = dict(groups)
    assert len(d) == 3
    assert set(f.src.contentpath for f in d[('tag1',)]) == set([((), 'a.rst'), ((), 'b.rst')])
    assert set(f.src.contentpath for f in d[('tag2',)]) == set([((), 'a.rst'), (('sub1',), 'c.rst')])
    assert set(f.src.contentpath for f in d[('tag3',)]) == set([((), 'b.rst'), (('sub1',), 'c.rst')])
